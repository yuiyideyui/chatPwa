var ortWasmThreaded = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    var SharedArrayBuffer =
      ...
      new WebAssembly.Memory({ initial: 0, maximum: 0, pc: !0 }).buffer
        .constructor;
    const ha =
      (a) =>
      async (...b) => {
    ...
    e.jsepInit = (a, b) => {
      if ("webgpu" === a) {
        ...
        const c = b[0];
        [e.nc, e.Nb, e.webnnEnsureTensor, e.Ob, e.webnnDownloadTensor] =
          b.slice(1);
    ...
    var Gc = (a) => {
      ...
      Q = (a, b, ...c) => {
        for (
          var d = 2 * c.length, f = Mc(), g = Nc(8 * d), h = g >>> 3, l = 0;
          l < c.length;
          l++
        ) {
          var m = c[l];
    ...
    function ld(a, b, c = {}) {
      ...
      delete kd[a];
      hd.hasOwnProperty(a) &&
        ((b = hd[a]), delete hd[a], b.forEach((f) => f()));
    }
    function T(a, b, c = {}) {
      return ld(a, b, c);
    }
    ...
    function zb(a, b, c) {
      ...
      T(
        a,
        { name: c, fromWireType: d, Cb: U, readValueFromPointer: d },
        { Sb: !0 },
      );
    }
    function Ab(a, b) {
    ...
    function Oa(a) {
      ...
      "function" === typeof Atomics.jc &&
        (Atomics.jc(H(), a >>> 2, a).value.then(Ra),
        (a += 128),
    ...
    function Fb(a, b, c, d, f) {
      ...
      c = (f >>> 0) >>> 3;
      for (f = 0; f < d; f++)
        Bd[f] = C[c + 2 * f] ? C[c + 2 * f + 1] : J()[(c + 2 * f + 1) >>> 0];
                ...
                try {
                  ...
                  A ||
                    ...
                    t &&
                      ...
                      (P += 1),
                      Gd(Jd),
                      "undefined" != typeof Fibers && Fibers.rc()));
                }
              }
            : d;
      return b;
    ...
    function Sd(a) {
      if (!A) {
        if (0 === Z) {
          ...
          2 === Z
            ? ((Z = 0), Gd(Wd), Y(t), (t = null), Pd.forEach(zd))
            : L(`invalid state: ${Z}`);
        return Kd;
      }
    }
    ...
    function bc(a, b) {
      ...
      H()[((b + 24) >>> 2) >>> 0] = a.getDay();
      var c =
        ((ee(a.getFullYear()) ? fe : ge)[a.getMonth()] + a.getDate() - 1) | 0;
      H()[((b + 28) >>> 2) >>> 0] = c;
    ...
    q || Sc();
    for (var te = Array(256), ue = 0; 256 > ue; ++ue)
      te[ue] = String.fromCharCode(ue);
    gd = te;
    ...
    e._OrtAddFreeDimensionOverride = (a, b, c) =>
      (e._OrtAddFreeDimensionOverride = K.Ja)(a, b, c);
    e._OrtAddSessionConfigEntry = (a, b, c) =>
      (e._OrtAddSessionConfigEntry = K.Ka)(a, b, c);
    e._OrtReleaseSessionOptions = (a) =>
      (e._OrtReleaseSessionOptions = K.La)(a);
    ...
    e._OrtGetInputOutputCount = (a, b, c) =>
      (e._OrtGetInputOutputCount = K.Oa)(a, b, c);
    ...
    e._OrtCreateTensor = (a, b, c, d, f, g) =>
      (e._OrtCreateTensor = K.Ra)(a, b, c, d, f, g);
    e._OrtGetTensorData = (a, b, c, d, f) =>
      (e._OrtGetTensorData = K.Sa)(a, b, c, d, f);
    ...
    e._OrtAddRunConfigEntry = (a, b, c) =>
      (e._OrtAddRunConfigEntry = K.Va)(a, b, c);
    ...
    e._OrtRunWithBinding = (a, b, c, d, f) =>
      (e._OrtRunWithBinding = K.ab)(a, b, c, d, f);
    e._OrtRun = (a, b, c, d, f, g, h, l) =>
      (e._OrtRun = K.bb)(a, b, c, d, f, g, h, l);
